...
const AppDemoMove = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button title='Move the Box to' onPress={handleMoveTopRight} />
            <Button title='Move the Box' onPress={handleMoveBottomLeft} />
            <Button title='Move the Box' onPress={handleMoveBottomRight} />
